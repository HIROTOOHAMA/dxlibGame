...
//ゲームフラグ
bool enterPressedLastFrame;     //エンターキーが押されたかどうかのフラグ
bool gameStartFlag;             //ゲーム開始フラグ
bool circleGenerationFlag;       //円の生成フラグ
bool gameEndFlag;               //ゲーム終了フラグ
bool enterPressAllowed;          //エンターキーを押されているかを許可するフラグ
